...
// 連線到 MongoDB
mongoose.connect(process.env.MONGODB_URI || 'mongodb://ecommerce_user:ecommerce_password@localhost:27017/ecommerce?authSource=ecommerce&connectTimeoutMS=30000&socketTimeoutMS=30000&serverSelectionTimeoutMS=30000&retryWrites=true&w=majority')
  .then(() => {
