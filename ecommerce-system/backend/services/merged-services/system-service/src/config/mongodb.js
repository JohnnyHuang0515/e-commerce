...
const connectMongoDB = async () => {
  try {
    ...
    console.log('✅ SYSTEM Service: MongoDB 連線成功');
    return true;
  } catch (error) {
    console.error('❌ SYSTEM Service: MongoDB 連線失敗:', error);
    return false;
  }
};
...
const disconnectMongoDB = async () => {
  try {
    ...
    console.log('✅ SYSTEM Service: MongoDB 連線已關閉');
    return true;
  } catch (error) {
    console.error('❌ SYSTEM Service: MongoDB 斷開連接失敗:', error);
    return false;
  }
};
