 ...
 * 商品讀取權限檢查
 */
const requireProductRead = checkPermission(['products:read']);

/**
 * 商品寫入權限檢查
 */
const requireProductWrite = checkPermission(['products:write']);

/**
 * 商品刪除權限檢查
 */
const requireProductDelete = checkPermission(['products:delete']);

/**
 * 管理員權限檢查
 */
const requireAdmin = checkPermission(['admin:*', 'products:manage']);
