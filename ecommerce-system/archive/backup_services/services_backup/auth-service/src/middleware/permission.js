 ...
 * 管理員權限檢查
 */
const requireAdmin = checkPermission(['admin:*', 'users:manage']);

/**
 * 用戶管理權限檢查
 */
const requireUserManage = checkPermission(['users:read', 'users:write']);

/**
 * 商品管理權限檢查
 */
const requireProductManage = checkPermission(['products:read', 'products:write']);
 ...
 * 分析數據權限檢查
 */
const requireAnalytics = checkPermission(['analytics:read']);

/**
 * 系統設定權限檢查
 */
const requireSettings = checkPermission(['settings:read', 'settings:write']);
